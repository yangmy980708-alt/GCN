...
etype='simplex'
'''求解区域[0,1]x[-0.25,0]'''
# xcg_u=loadmat('D:/Matlab2019b/bin/mesh/NS2/xcg.mat')
# e2vcg_u_gmsh=loadmat('D:/Matlab2019b/bin/mesh/NS2/e2vcg.mat')
# xcg2_p=loadmat('D:/Matlab2019b/bin/mesh/NS2/xcg2.mat')
# e2vcg2_p=loadmat('D:/Matlab2019b/bin/mesh/NS2/e2vcg2.mat')
# e2bnd_up = loadmat('D:/Matlab2019b/bin/mesh/NS2/e2bnd.mat')
''' 56element'''
xcg_u=loadmat('D:/Matlab2019b/bin/mesh/NS_56element/xcg.mat')
e2vcg_u_gmsh=loadmat('D:/Matlab2019b/bin/mesh/NS_56element/e2vcg.mat')
xcg2_p=loadmat('D:/Matlab2019b/bin/mesh/NS_56element/xcg2.mat')
e2vcg2_p=loadmat('D:/Matlab2019b/bin/mesh/NS_56element/e2vcg2.mat')
e2bnd_up = loadmat('D:/Matlab2019b/bin/mesh/NS_56element/e2bnd.mat')
...
visualize_fem(ax1, msh, uabs[e2vcg], {"plot_elem": False, "nref": 10}, [])
ax1.set_title('FEM U ')
ax2 = plt.subplot(2,2,2)
visualize_fem(ax2, msh, uuabs[e2vcg], {"plot_elem": False, "nref": 4}, [])
ax2.set_title('analytical U')
ax3 = plt.subplot(2, 2 ,3)
visualize_fem(ax3, msh, uabs_GCNN[e2vcg], {"plot_elem": False, "nref": 2}, [])
