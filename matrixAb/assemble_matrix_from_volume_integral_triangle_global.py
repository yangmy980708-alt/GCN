...
def assemble_matrix_from_volume_integral_triangle_global(coefficient_function, M_partition, T_partition, M_basis_trial, T_basis_trial, T_basis_test,
    ...
    #
    #     # Loop through all combinations of trial and test basis functions
    #     for alpha in range(number_of_trial_local_basis):
    #         for beta in range(number_of_test_local_basis):
    #             temp = Gauss_quadrature_for_volume_integral_trial_test_triangle(
    #                 coefficient_function_name, Gauss_coefficient_local_triangle, Gauss_point_local_triangle,
    #                 vertices, trial_basis_type, alpha, trial_derivative_degree_x, trial_derivative_degree_y,
    #                 test_basis_type, beta, test_derivative_degree_x, test_derivative_degree_y)
    #
    #             # Update the matrix at the corresponding position
    #             r[T_basis_test[beta, n], T_basis_trial[alpha, n]] += temp
    #
    # return r
