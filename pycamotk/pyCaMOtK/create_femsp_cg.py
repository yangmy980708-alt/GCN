import numpy as np
import pdb
from pycamotk.pyCaMOtk.lfcnsp import LocalFunctionSpace#,LocalFunctionSpace_f
from pycamotk.pyCaMOtk.create_ldof2gdof_cg import create_ldof2gdof_cg,create_ldof2gdof_cg_mixed2
from pycamotk.pyCaMOtk.create_elem_strct import create_elem_strct,create_elem_strct_mixed2
from pycamotk.pyCaMOtk.create_elem_data import create_elem_data
from pycamotk.pyCaMOtk.create_sparsity_strct import create_sparsity_strct
