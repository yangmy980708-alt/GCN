...
from pycamotk.pyCaMOtk.ndist_mltdim import ndist_mltdim_hcube
from pycamotk.pyCaMOtk.tens_core import mltidx_from_linidx
from pycamotk.pyCaMOtk.geom_mltdim import Hypercube
