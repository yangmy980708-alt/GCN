from pycamotk.pyCaMOtk.create_ldof2gdof_dg import create_ldof2gdof_dg
from pycamotk.pyCaMOtk.create_ldof2gdof_cg import create_ldof2gdof_cg
from pycamotk.pyCaMOtk.create_elem_strct import create_elem_strct
from pycamotk.pyCaMOtk.create_elem_data import create_elem_data
from pycamotk.pyCaMOtk.lfcnsp import LocalFunctionSpace
from pycamotk.pyCaMOtk.create_sparsity_strct_dg import create_sparsity_strct_dg
...
class create_femsp_dg(object):
	...
	def __init__(self,prob,msh,ptest,ptrial):
		...
		"多了 nelem 这一项"
		self.nelem=self.msh.e2vcg.shape[1]
		self.e2e=self.msh.e2e
