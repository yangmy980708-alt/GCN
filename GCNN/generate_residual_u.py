...
def generate_residual_u(U,
    ...
    # phih = U[:number_of_unknowns_Darcy]#非线性项不含Darcy
    U = U.to(device='cuda')
    uh1 = U[number_of_unknowns_Darcy:number_of_unknowns_Darcy + number_of_FE_nodes_u]
    uh2 = U[number_of_unknowns_Darcy + number_of_FE_nodes_u:number_of_unknowns_Darcy + 2 * number_of_FE_nodes_u]
    # ph = U[number_of_unknowns_Darcy + 2 * number_of_FE_nodes_u:number_of_all_unknowns]#非线性项不含压力
    ...
    # Re = A_sum * U - b_sum #这里算出来是（51，51）维度错误，应该是（51，1）
    Re = torch.matmul(A_sum, U) - b_sum
