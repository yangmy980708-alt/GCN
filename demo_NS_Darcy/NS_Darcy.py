...
from matrixAb.assemble_matrix_from_volume_integral_FE_triangle_element import assemble_matrix_from_volume_integral_FE_triangle_element
from matrixAb.assemble_vector_from_volume_integral_2FE_triangle import assemble_vector_from_volume_integral_2FE_triangle
from matrixAb.get_2D_solution_and_maximum_error import get_2D_solution_and_maximum_error
from matrixAb.get_2D_solution_and_maximum_error_Stokes import get_2D_solution_and_maximum_error_Stokes
...
from matrixAb.treat_Neumann_boundary_triangle import treat_Neumann_boundary_triangle
from matrixAb.treat_Robin_boundary_triangle import treat_Robin_boundary_triangle
...
from matrixAb.treat_stress_boundary_triangle_Stokes import treat_stress_boundary_triangle_Stokes
from matrixAb.treat_Robin_boundary_triangle_Stokes import treat_Robin_boundary_triangle_Stokes
...
#from matrixAb.function_data import *

left_S=0;right_S=4;bottom_S=-2;top_S=0
left_D=0;right_D=4;bottom_D=0;top_D=4
...
[A_Darcy, b_Darcy] = assemble_fixed_matrix_vector_for_Poisson(M_partition_D, T_partition_D, M_basis_phi, T_basis_phi, T_basis_phi, 2)
...
[A_Stokes, b_Stokes] = assemble_fixed_matrix_vector_for_Stokes_Taylor_Hood(M_partition_S, T_partition_S, M_basis_u, T_basis_u, T_basis_u, T_basis_p)
...
# [solution_2D_phi, maxerror_phih] = get_2D_solution_and_maximum_error(phih, N1_basis_phi, N2_basis_phi, left_D,
#                                                                          bottom_D, h_basis_phi)
# [solution_2D_uh1, solution_2D_uh2, solution_2D_ph, maxerror_uh,
#      maxerror_ph] = get_2D_solution_and_maximum_error_Stokes(uh1, uh2, ph, N1_basis_u, N2_basis_u, N1_basis_p,
#                                                              N2_basis_p, left_S, bottom_S, h_basis_u, h_basis_p)
# maximum_error_phih_at_all_nodes_of_FE = maxerror_phih
# maximum_error_uh_at_all_nodes_of_FE = maxerror_uh
# maximum_error_ph_at_all_nodes_of_FE = maxerror_ph
